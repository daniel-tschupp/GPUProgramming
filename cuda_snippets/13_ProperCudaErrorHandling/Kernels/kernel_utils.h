...
void cpyAsyncToDevice(float* devPtr, float* hostPtr, size_t size, cudaStream_t* stream);
void cpyAsyncToHost(float* devPtr, float* hostPtr, size_t size, cudaStream_t* stream);
